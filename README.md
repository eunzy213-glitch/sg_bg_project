...
🔹본 실험 결과는 **추가적인 생리·생활 변수(SG_PLUS_META)를 포함한 확장 모델의 필요성**을 명확히 보여주며, 이후 실험에서는 **다변량 입력을 통한 성능 개선을 중점적으로 분석**합니다.
...
> 📌**SG는 BG 예측에 의미 있는 출발점이지만 임상적으로 신뢰 가능한 수준의 예측을 위해서는 생리·생활 메타데이터와의 결합이 필요합니다.**
